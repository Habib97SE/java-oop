...
public class TestBank2
{
	...
	public void test() throws FileNotFoundException, InterruptedException,  ParseException
	{
		...
		testingGetCustomer("8505221898", "[8505221898 Kalle Karlsson, 1001 -4 500,00 kr Kreditkonto 7,0 %, 1003 500,00 kr Sparkonto 1,2 %]");
		...
		testingGetAccount("8505221898", 1001, "1001 -4 500,00 kr Kreditkonto 7,0 %");        
	...
	private void testingGetCustomer(String pNo, String facit)
	{
        ...
        if(result != null)
        {
            ...
            // and '.' with ',' (so that both 1.2 % and 1,2 % works)
            str = str.replaceAll("\\u00a0"," "); 
            str = str.replaceAll("−","-");  
            str = str.replaceAll("\\.",",");
        }
	 ...
	 */
	private void testingWithdraw(String pNo, int accountId, int amount, boolean facit) throws ParseException
	{
	    // Check if we get the right value back and give feedback to the user
